    ...
    <div className='subscription'>
        ...
        <form onSubmit={submitHandler}>
            <div className='form-components'>
                ...
                <input className={`${isValid?'':'red_border'}`} placeholder='Enter title' onChange={titleChangeHandler} value={form.userTitle} type="text" name="title" id="title" />
                ...
                <input className={`${isValid?'':'red_border'}`} onChange={amountChangeHandler} value={form.userAmount} placeholder='Enter amount' type="text" name="amount" id="amount" />
